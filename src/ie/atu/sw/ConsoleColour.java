...
/** 
 * The class responsible for setting colour for console
 */
public enum ConsoleColour {
	...
	/**
     * Retrieves the description of the console color.
     *
    ...
    /**
     * Retrieves the ANSI escape code for the console color.
     *
    ...
    /**
     * Converts the console color to its ANSI escape code representation.
     *
     * @return The ANSI escape code for the console color.
     */	
	@Override
